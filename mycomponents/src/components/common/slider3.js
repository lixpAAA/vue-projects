...
/* harmony default export */ var mainvue_type_script_lang_js_ = ({
  ...
  computed: {
    ...
    barSize: function barSize() {
      ...
      100 * Math.abs(this.firstValue) / (this.max - this.min) + "%";
    },
    barStart: function barStart() {
      return this.range ? 100 * (this.minValue - this.min) / (this.max - this.min) + "%" : this.firstValue < 0 ? 50 - 100 * Math.abs(this.firstValue) / (this.max - this.min) + "%" : "50%";
    },
    precision: function precision() {
